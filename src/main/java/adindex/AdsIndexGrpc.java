...
public final class AdsIndexGrpc {
  ...
  public static final io.grpc.MethodDescriptor<adindex.AdsRequest,
      adindex.AdsReply> METHOD_GET_ADS =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "adindex.AdsIndex", "GetAds"),
          io.grpc.protobuf.ProtoUtils.marshaller(adindex.AdsRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(adindex.AdsReply.getDefaultInstance()));
  ...
  public static final class AdsIndexBlockingStub extends io.grpc.stub.AbstractStub<AdsIndexBlockingStub> {
    ...
    /**
     */
    public adindex.AdsReply getAds(adindex.AdsRequest request) {
  ...
  public static final class AdsIndexFutureStub extends io.grpc.stub.AbstractStub<AdsIndexFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<adindex.AdsReply> getAds(
        adindex.AdsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ADS:
          serviceImpl.getAds((adindex.AdsRequest) request,
              (io.grpc.stub.StreamObserver<adindex.AdsReply>) responseObserver);
          break;
        default:
  ...
  private static final class AdsIndexDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return adindex.SearchAdvertising.getDescriptor();
    }
  }
